...
public BotPosePrediction(double imuAngle, LimeLight limeLight) {
    Translation2d[] wheelsMeters = new Translation2d[] { new
    Translation2d(0.26035, 0.26035),
    ...
    poseEstimator = new SwerveDrivePoseEstimator(kinematics, new
    Rotation2d(imuAngle), modulePositions,
...
public void tick(double dTime) {
    ...
    new Pose2d(limeLight.getRobotX(), limeLight.getRobotY(), new
    Rotation2d(limeLight.getRobotYaw())),
