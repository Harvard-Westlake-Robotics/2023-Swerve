...
// 	Double previousTime;
// 	private double LimeLightPositionX, LimeLightPositionY, LimeLightPositionZ, pitch, yaw, roll;
...
// 		Vector2 predictedPosition = new Vector2(LimeLightPositionX, LimeLightPositionY).add(predictedPositionChange);
