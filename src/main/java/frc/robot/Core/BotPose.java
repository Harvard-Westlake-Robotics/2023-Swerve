...
// private static double botPositionX, botPositionY, botPositionZ, pitch, yaw,
// roll;
...
// latency = LimeLight.getRobotLatency() + (currentTimeSinceEpoch -
...
// Vector2 predictedPosition = new Vector2(botPositionX,
// botPositionY).add(predictedPositionChange);
