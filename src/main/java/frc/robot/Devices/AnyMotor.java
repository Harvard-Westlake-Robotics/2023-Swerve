...
/**
 * AnyMotor is an abstract base class representing a motor with basic functionalities.
...
public abstract class AnyMotor {
    ...
    /**
     * Gets the number of revolutions since the last reset, accounting for motor direction.
     * @return The number of revolutions.
     */
    ...
    /**
     * The tick method that updates the motor state, meant to be overridden if needed.
